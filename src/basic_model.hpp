...
struct basic_model {
	...
	void draw(const glm::mat4 &view, const glm::mat4 proj) {
		...
		glUniform1fv(glGetUniformLocation(shader, "ambientStrength"), 1, &ambientStrength);
		glUniform1fv(glGetUniformLocation(shader, "specular"), 1, &specular);
